...
CODE_PATTERN = re.compile(
    r"[\"']((?:ASK|CANDIDATE|COLLECTION|COMPATIBILITY|DATABASE|DEGRADATION|DOCUMENT|EMBEDDING|EXCLUSION|EXPORT|EXTRACTION|FILE|FORMAT|GENERATION|INBOX|INCREMENTAL|INDEX|JOB|KNOWN_FOLDER|LOCAL_CONFIG|LOG|MEMBERSHIP|MODEL|NOT_A_FILE|OCR|OPERATION|PARSER|PATH|PDF|PREVIEW|RELATION|REQUEST|REVISION|ROOT|SCAN|SCHEMA|SEARCH|TASK|WATCHER|WELCOME|WORKER)_[A-Z0-9_]+|NOT_A_FILE)[\"']"
)
