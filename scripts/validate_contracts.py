...
SOURCE_ROOTS = (
    ...
    REPO_ROOT / "crates" / "core" / "examples",
...
CODE_PATTERN = re.compile(
    r"[\"']((?:ASR|ASK|CANDIDATE|COLLECTION|COMPATIBILITY|DATABASE|DEGRADATION|DOCUMENT|EMBEDDING|EVALUATION|EXCLUSION|EXPORT|EXTRACTION|FILE|FORMAT|GENERATION|IMAGE|INBOX|INCREMENTAL|INDEX|JOB|KNOWN_FOLDER|LOCAL_CONFIG|LOG|MEMBERSHIP|MEMORY|MODEL|NOT_A_FILE|OCR|OPERATION|PARSER|PATH|PDF|PREVIEW|PRESET|PROCESSING|PROFILE|RAG|RELATION|REQUEST|REVISION|ROOT|RUNTIME|SCAN|SCHEMA|SEARCH|SEMANTIC|SESSION|SETTINGS|STATUS|STORAGE|TASK|VISION|WATCHER|WELCOME|WORKER)_[A-Z0-9_]+|NOT_A_FILE)[\"']"
)
